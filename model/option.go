...
func InitOptionMap() {
	...
	common.OptionMap["RequireRedemptionForOAuth"] = strconv.FormatBool(common.RequireRedemptionForOAuth)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" || key == "RequireRedemptionForOAuth" {
		...
		case "RequireRedemptionForOAuth":
			common.RequireRedemptionForOAuth = boolValue
