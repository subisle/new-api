...
// The classic frontend has been removed, so legacy values are normalized to default.
func SetTheme(t string) {
	themeValue.Store("default")
}

// ThemeAwarePath rewrites legacy /console/* paths to the default frontend equivalents.
...
var RequireRedemptionForOAuth = false // 是否强制 OAuth 注册需要兑换码
